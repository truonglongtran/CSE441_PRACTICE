...
//tuyệt đối không được cập nhật giao diện trong hàm này @Override
    protected Void doInBackground(Void... arg0) {
        for (int i = 0; i <= 100; i++) { //nghi 100 milisecond thì tiến hành update UI SystemClock.sleep(100);
...
//vi publishProgress chỉ truyền 1 đối số
...
// TODO Auto-generated method stub super.onPostExecute (result); Toast.makeText(contextCha, "Update xong roi do!", Toast.LENGTH LONG).show(); }
